...
#добавляет в pluginPath все папки из CUSTOM_GIZMOS_PATHS если они не запрещены IGNORE_FOLDERS_FULL
...
#также это запустит init.py файлы в папках из каждой папки из списка CUSTOM_GIZMOS_PATHS(если эти папки не запрещены IGNORE_FOLDERS_FULL)
